...
</tr><tr><td><input class="fm" onKeyUp="calculateRest();" name="m2[]" size="5" maxlength="6" value={rs1_p}><input type="hidden" name="m1[]" value={rs1}></td><td><input class="fm" onKeyUp="calculateRest();" name="m2[]" size="5" maxlength="6" value={rs2_p}><input type="hidden" name="m1[]" value={rs2}></td><td><input class="fm" onKeyUp="calculateRest();" name="m2[]" size="5" maxlength="6" value={rs3_p}><input type="hidden" name="m1[]" value={rs3}></td><td><input class="fm" onKeyUp="calculateRest();" name="m2[]" size="5" maxlength="6" value={rs4_p}><input type="hidden" name="m1[]" value={rs4}></td>
