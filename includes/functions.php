...
function display_bs($page, $title = '', $topnav = true, $rightnav = true, $metatags = '')
{
    global $db, $link, $game_config, $debug, $user, $wg_village;
    echo_head_bs($title, $metatags);
    echo "$page";
...
function echo_head_bs($title = '', $metatags = '')
{
    global $db, $user, $lang, $timeAgain, $game_config,$village;
    includeLang ('simple_header');
    $parse                = $lang;
    $parse['title']       = $game_config['game_name'];
    $parse['metatags']    = $metatags;
    ...
    if (check_user())
    {
        ...
        echo parsetemplate(gettemplate('simple_header_bs'), $parse);
        include_once ("func_security.php");
    ...
    else
    {
        ...
        $parse['name']      = $lang['Login'];
        $parse['show_date'] = showDate();
        echo parsetemplate(gettemplate('simple_header2_bs'), $parse);
    }
